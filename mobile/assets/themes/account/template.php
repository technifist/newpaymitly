...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark">
      ...
      <a class="navbar-brand" href="#">
				<img src="<?php echo base_url();?>assets/themes/account/img/main-logo.png" height="30" alt=""><a href="<?php echo base_url('logout'); ?>" class="my-2 my-sm-0 mr-3" id="myLogout" style="font-size:10px;color:white; "><?php echo lang('core button logout'); ?></a>
			</a>
