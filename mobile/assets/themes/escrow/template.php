			...
			<div class="footer">
				<div class="container">
					<div class="row">
                       ...
                       <a href="https://play.google.com/store/apps/details?id=com.nauman.orixpay">
	<img src="<?php echo base_url();?>assets/themes/escrow/img/playstore.png" style="margin-right: 5px;
width: 134px;
height: 43px;
float: left;" height="60" alt="Get it on Google Play">
...
<a href="#"> <img src="<?php echo base_url();?>assets/themes/escrow/img/appstore.png" style="margin-right: 5px;
width: 134px;
height: 43px;
margin-top: 12px;
...
<a href="https://www.orixpay.com/wp-plugin/orixpay-wc-payment-gateway.zip"> <img src="<?php echo base_url();?>assets/themes/escrow/img/wordpress2.png" style="margin-right: 13px;
width: 134px;
height: 43px;
margin-top: 12px;
float: left;" height="60" alt="Get it on WordPress"> 
							...
							<div class="dropdown dropup text-right">
								...
								<button style="float: left;" id="session-language" class="btn btn-light dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
