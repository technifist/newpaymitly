...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark">
      ...
      <button class="navbar-toggler" id="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
					...
					<div class="row">
						<div class="col-md-6">
							<ul class="list-inline">
								<li class="list-inline-item mr-4"><a href="https://beta.companieshouse.gov.uk/search?q=orixpay">&copy; 2017-20 OrixPay Limited</a></a></li>
								<li class="list-inline-item mr-2"><a href="<?php echo base_url('agreement'); ?>">T&C</a></li>
								<li class="list-inline-item mr-2"><a href="<?php echo base_url('privacy'); ?>"><?php echo lang('core button privacy'); ?></a></li>
								<li class="list-inline-item mr-2"><a href="<?php echo base_url('instructions'); ?>">Fee Chart</a></li>
							</ul>
                       ...
                       <a href="https://play.google.com/store/apps/details?id=com.nauman.orixpay" target="_blank">
	<img src="<?php echo base_url();?>assets/themes/escrow/img/playstore.png" style="margin-right: 5px;
width: 43px;
height: 43px;
float: left;margin-left: 265px;" height="60" alt="Get it on Google Play">
...
<a href="#" target="_blank"> <img src="<?php echo base_url();?>assets/themes/escrow/img/appstore.png" style="margin-right: 5px;
width: 43px;
height: 43px;
margin-top: 12px;
float: left;" height="60" alt="Get it on AppStore"> 
                            
                            </a>
<a href="https://www.orixpay.com/wp-plugin/orixpay-wc-payment-gateway.zip"> <img src="<?php echo base_url();?>assets/themes/escrow/img/wordpress2.png" style="margin-right: 5px;
width: 43px;
height: 43px;
margin-top: 12px;
float: left;" height="60" alt="enable with woocommerce"> 
							...
							<div class="dropdown dropup text-right">
								...
								<button style="float: right;" id="session-language" class="btn btn-light dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
