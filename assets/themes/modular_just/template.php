        ...
        <aside class="AppSidebar">
          ...
          <footer id="SidebarFooter" class="SidebarFooter">
            <nav class="SidebarFooterNav">
              ...
              <a href="https://www.orixpay.com/contact" target="_blank" id="SidebarToggleHelpLink" class="NavLink LinkToggleHelp" data-placement="top" data-trigger="hover" title="Help">
        ...
        <footer class="Footer AppFooter"> 
					<div class="row">
						<div class="col-md-12 -text-right">
							<?php echo lang('core text page_rendered'); ?> | PHP v<?php echo phpversion(); ?> | MySQL v<?php echo mysqli_get_client_version(); ?> | CodeIgniter v<?php echo CI_VERSION; ?> | OrixPay v<?php echo $this->settings->site_version; ?>
						</div>
					</div>
				</footer>
      </div>
