                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="home">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                <div class="radio-card">
                                                                    <input type="radio" class="planes-radio"
                                                                           name="method" value="ux" id="10"/>
                                                                    <label for="10" id="10">
                                                                        <span class="card-title"><img
                                                                                    class="img-responsive"
                                                                                    src="<?php echo base_url(); ?>themes/private/img/pay/ux.png"
                                                                                    alt=""></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php if ($this->commission->display->check_pp_sci) : ?>
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                <div class="radio-card">
                                                                    <input type="radio" class="planes-radio"
                                                                           name="payment" value="paypal" id="2"/>
                                                                    <label for="2" id="2">
                                                                        <span class="card-title"><img
                                                                                    class="img-responsive"
                                                                                    src="<?php echo base_url(); ?>themes/private/img/pay/paypal.png"
                                                                                    alt=""></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php if ($this->commission->display->check_btc_sci) : ?>
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                <div class="radio-card">
                                                                    <input type="radio" class="planes-radio"
                                                                           name="payment" value="btc" id="3"/>
                                                                    <label for="3" id="3">
                                                                        <span class="card-title"><img
                                                                                    class="img-responsive"
                                                                                    src="<?php echo base_url(); ?>themes/private/img/pay/btc.png"
                                                                                    alt=""></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php if ($this->commission->display->check_adv_sci) : ?>
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                <div class="radio-card">
                                                                    <input type="radio" class="planes-radio"
                                                                           name="payment" value="adv" id="4"/>
                                                                    <label for="4" id="4">
                                                                        <span class="card-title"><img
                                                                                    class="img-responsive"
                                                                                    src="<?php echo base_url(); ?>themes/private/img/pay/adv.png"
                                                                                    alt=""></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                            ...
                                            <?php if ($this->commission->display->check_payeer_sci) : ?>
                                                ...
                                                <div class="col-md-6 col-xs-6">
                                                    <div class="radio-card">
                                                        <input type="radio" class="planes-radio" name="payment"
                                                               value="payeer" id="9"/>
                                                        <label for="9" id="9">
                                                            <span class="card-title"><img class="img-responsive"
                                                                                          src="<?php echo base_url(); ?>themes/private/img/pay/payeer.png"
                                                                                          alt=""></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <?php if ($this->commission->display->check_perfect_sci) : ?>
                                                ...
                                                <div class="col-md-6 col-xs-6">
                                                    <div class="radio-card">
                                                        <input type="radio" class="planes-radio" name="method"
                                                               value="perfect" id="8"/>
                                                        <label for="8" id="8">
                                                            <span class="card-title"><img class="img-responsive"
                                                                                          src="<?php echo base_url(); ?>themes/private/img/pay/perfect.png"
                                                                                          alt=""></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <?php if ($this->commission->display->swift_sci_check) : ?>
                                                ...
                                                <div class="col-md-6 col-xs-6">
                                                    <div class="radio-card">
                                                        ...
                                                        <label for="7" id="7">
                                                            <span class="card-title"><img class="img-responsive"
                                                                                          src="<?php echo base_url(); ?>themes/private/img/pay/swift.png"
                                                                                          alt=""></span>
                                                        </label>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane" id="payment">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="username" id="login"
                                                           placeholder="Enter lagin or email">
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-right">
                                                    <a href="#home" data-toggle="tab"
                                                       class="btn btn-default"><?php echo lang('core button cancel'); ?></a>
                                                    <button type="submit"
                                                            class="btn btn-primary"><?php echo lang('core payment go'); ?></button>
                                                </div>
                                    ...
                                    <?php if ($this->commission->display->check_pp_sci) : ?>
                                        <form id="paypal" name=paypal method="post"
                                            ...
                                            <input type="hidden" name="receiver_email"
                                                   value="<?php echo $this->commission->display->account_pp_sci ?>"/>
                                            <input type="hidden" name="business"
                                                   value="<?php echo $this->commission->display->account_pp_sci ?>"/>
                                            <input type="hidden" name="notify_url"
                                                   value="<?php echo base_url(); ?>SCI/sci_paypal"/>
                                            ...
                                            <input type="hidden" name="currency_code"
                                                   value="<?php echo $this->currencys->display->base_code ?>">
                                    ...
                                    <?php if ($this->commission->display->check_perfect_sci) : ?>
                                        <form action="https://perfectmoney.is/api/step1.asp" id="perfect" method="POST">
                                            <input type="hidden" name="PAYEE_ACCOUNT"
                                                   value="<?php echo $this->commission->display->account_perfect_sci ?>">
                                            ...
                                            <input type="hidden" name="STATUS_URL"
                                                   value="<?php echo base_url(); ?>SCI/sci_perfect">
                                    ...
                                    <?php if ($this->commission->display->check_btc_sci) : ?>
                                        <form id="btc" method="POST" action="https://merchant.dotpay.io/api/">
                                            <input type="hidden" name="merchant_id"
                                                   value="<?php echo $this->commission->display->shop_btc_sci ?>">
                                            <input type="hidden" name="currency"
                                                   value="<?php echo $this->currencys->display->base_code ?>">
                                            <input type="hidden" name="comment" value="<?php echo $merchant; ?>">
                                            <input type="hidden" name="sub1" value="id">
                                            <input type="hidden" class="form-control" name="amount"
                                                   value="<?php echo $amount; ?>">
                                            <div class="row">
                                                <div class="col-md-12">
...
<script>
    var checkForm = document.querySelector('#check');
